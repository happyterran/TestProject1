...
<div class="content">
      ...
      <!-- Page heading -->
      <div class="page-head">
        <h2 class="pull-left"><i class="icon-pencil"></i> 차수별 입력건수</h2>
        <!-- Breadcrumb -->
        <div class="bread-crumb pull-right">
          <a href="/Login.asp"><i class="icon-home"></i> Home</a> 
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="/StatsDegree.asp" class="bread-current">차수별 입력건수</a>
        </div>
...
<!-- 
            <%'##########  리스트수  ##########%>
            <SELECT NAME="SelectCount" onchange="MenuForm.submit();" style="width: 150px;">
 ...
 -->
            ...
            Rs11.Open StrSql, Dbcon%>
            <SELECT NAME="FormStatsMemberID" onchange="MenuForm.submit();" style="width: 150px;">
                <%If Rs11.BOF = false Then%>
            ...
            <button type="button" class="btn" onclick="javascript: document.location.href='/StatsDegree.asp';" style="margin-bottom: 10px;">
                ...
                '모집단위, 구분2, 모집시기, 구분1
                'StrSql = StrSql & vbCrLf & "order by substring(A.SubjectCode,4,2), substring(A.SubjectCode,7,2), substring(A.SubjectCode,1,2), right(A.SubjectCode,1), B.StatsResult" 
                  ...
                  <div class="widget" style="margin-top: 0; padding-top: 0;">
                    <div class="widget-head">
                      ...
                      <div class="widget-icons pull-right">
                        ...
                        <button type="button" class="btn btn-success" onclick="document.location.href='StatsDegreeFileDownloadExcel.asp';">
                        ...
                        <div class="row-fluid">
                          ...
                          <div class="span12">
                            <table class="table table-striped table-hover table-bordered" style="atable-layout: fixed;">
                                <colgroup><col width="9%"></col><col width="9%"></col><col width="19%"></col><col width="9%"></col><col width="7%"></col><col width="5%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col><col width="6%"></col></colgroup>
                              <thead>
                                <tr>
                                    <td colspan="1" style="padding: 7px 0px 6px 0px; text-align: center;">코드</td>
                                ...
                                <%if Rs1.eof then%>
                                    <tbody>
                                    <TR><TD colspan="12" style="height: 40; text-align: center;">모집단위 기록이 없습니다.<BR>
                                    </tbody>
                                <%else%>
                              <tbody>
                                <%
                            ...
                            do Until Rs1.EOF
                                ...
                                %>
                                    ...
                                    <td colspan="1" style="padding: 0px 0px 0px 0px; text-align: left;"  ><INPUT TYPE="text" NAME="Division1" style="width: 95%; height: 32px; border:0px; text-align: left; padding: 0px 0px 0px 5px; margin: 0px; backgroud-color: #f9f9f9; background-image: none;" maxlength="35" value="<%=Division1%>" onkeyup="document.getElementById('Checkbox<%=i%>').checked=true;"></td>
                                    <td colspan="1" style="padding: 0px 0px 0px 0px; text-align: right;" ><INPUT TYPE="text" NAME="QuorumFix" style="width: 75%; height: 32px; border:0px; text-align: right; padding: 0px 10px 0px 0px; margin: 0px; backgroud-color: #f9f9f9; background-image: none;" maxlength="35" value="<%=QuorumFix%>" onkeyup="document.getElementById('Checkbox<%=i%>').checked=true;"></td>
                                     -->
                                <TR>
                                    <TD colspan="1" style="<%=BGColor%> padding: 0px 0px 0px 0px; text-align: left;"><INPUT TYPE="text" NAME="SubjectCode" style="width: 100%; height: 32px; border:0px; text-align: left; padding: 0px; margin: 0px; <%=BGColor%>" value="<%=SubjectCode%>"></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 0px 0px 1px; text-align: left;" nowrap><%=Division0%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 0px 0px 0px 0px; text-align: left;"><INPUT TYPE="text" NAME="SubjectCode" style="width: 100%; height: 32px; border:0px; text-align: left; padding: 0px; margin: 0px; <%=BGColor%>" value="<%=Division1%>"></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 0px 0px 1px; text-align: left;" nowrap><%=Subject%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 0px 0px 1px; text-align: left;" nowrap><%=Division2%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 0px 0px 0px 1px; text-align: left;" nowrap><%=Division3%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 10px 5px 0px; text-align: right; border-left: #AAA 2px solid;" ><%=RegistPlanCount%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 10px 5px 0px; text-align: right;" ><%=UndecidedCount%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 10px 5px 0px; text-align: right;" ><%=NonConnectedCount%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 10px 5px 0px; text-align: right; border-right: #AAA 2px solid;" ><%=RegistCount%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 10px 5px 0px; text-align: right;" ><%=AbandonCount%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 10px 5px 0px; text-align: right;" ><%=NonRegistCount%></TD>
                                    <TD colspan="1" style="<%=BGColor%> padding: 8px 10px 5px 0px; text-align: right;" ><%=RefundCount%></TD>
                                </TR>
                                <%
                            Loop
                            Rs1.Close
                            Set Rs1 = Nothing%>
                                <!-- 신구대 수정사항 ########## 총 합 ########## -->
                                <tr>
                                    <TD colspan="6" style="background-color: #FFFFFF; text-align: center;"></TD>
                                    <td colspan="1" style="padding: 7px 0px 6px 0px; text-align: center; border-left: #AAA 2px solid;">등록예정</td>
                                    <td colspan="1" style="padding: 7px 0px 6px 0px; text-align: center;">미결정</td>
                                    <td colspan="1" style="padding: 7px 0px 6px 0px; text-align: center;">미연결</td>
                                    <td colspan="1" style="padding: 7px 0px 6px 0px; text-align: center; border-right: #AAA 2px solid;">등록완료</td>
								...
								<TR>
                                    <TD colspan="6" style="background-color: #FFFFFF; text-align: center;"><B>총합</B></TD>
                                ...
                                <tr>
                                    <td colspan="12"  style="text-align: center; padding: 1px 0px 0px 10px;">
                                        <div class="span12">
...
<SCRIPT LANGUAGE="JavaScript">//$(window).load(function(){noty({text: '변동소계가 0 이 아닌 전형이 있습니다. <br>모집인원을 정확히 확인해 주세요.',layout:'top',type:'error',timeout:5000});})</SCRIPT>
<%End If%>
