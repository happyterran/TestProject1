...
If Rs1.EOF = false Then
    ...
    FileName = Server.URLEncode(MYear & "학년도 " & FileName) & ".xls"
	...
	<TR bgcolor='<%=BackgroundColor%>' align='center' height='20'>
        ...
        <TD width="60">구분3</TD>
        <TD width="60">차수</TD>
        <TD width="110">발신번호</TD>
        <TD width="60">상담원</TD>
        <TD width="60">수신자</TD>
        <TD width="60">결과</TD>
        <TD width="60">전화횟수</TD>
        <TD width="110">녹음파일</TD>
        <TD width="110">메모</TD>
        <TD width="140">작업시각</TD>
        <TD width="110">전화1</TD>
        <TD width="110">전화2</TD>
        <TD width="110">전화3</TD>
        <TD width="110">전화4</TD>
...
If Rs1.EOF = false Then
	...
	do Until Rs1.EOF
		...
		<TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=SubjectCode%></TD>
        ...
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=Degree%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=Tel%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=MemberID%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=ReceiverTempStr%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=ResultTempStr%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=CallCount%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=SaveFile%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=Memo%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@;" nowrap><%=InsertTime%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@; text-align: left; padding-left: 20px;" nowrap><%=Tel1%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@; text-align: left; padding-left: 20px;" nowrap><%=Tel2%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@; text-align: left; padding-left: 20px;" nowrap><%=Tel3%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@; text-align: left; padding-left: 20px;" nowrap><%=Tel4%></TD>
        <TD style="background-color: <%=BackgroundColor%>; mso-number-format:\@; text-align: left; padding-left: 20px;" nowrap><%=Tel5%></TD>
		</TR><%
		'지원자 리스트 프로시져
		'######################################### End
