      ...
      <!-- Page heading ends -->
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            ...
            <SELECT NAME="FormSelectCount" onchange="MenuForm.submit();" style="width: 150px;">
                <option value="">----학과 표시방법----</option>
                <option value=""<%If SelectCount=""Then%> selected<%End If%>>전체 학과</option>
		...
		<%'##########  모집단위 선택  ########## 
			...
			If true or Session("FormStatsSubject")<>"" and Session("FormStatsDivision0")<>"" and Session("CountTemp") >= 1 Then
				...
				StrSql = StrSql & vbCrLf & "order by RIGHT(MAX(SubjectCode), 2) "
				'Response.Write StrSql & "<BR>"
				Rs11.Open StrSql, Dbcon
				If Rs11.BOF = false Then%>
            ...
            <button type="button" class="btn" onclick="javascript: document.location.reload();" style="margin-bottom: 10px;">
                ...
                'StrSql = StrSql & vbCrLf & "order by a.division0 asc, a.subject, A.SubjectCode, a.division2 "
				'정원내 정원
               'StrSql = StrSql & vbCrLf & "and Division1 in ("
               'StrSql = StrSql & vbCrLf & "'일반전형'"
               'StrSql = StrSql & vbCrLf & ",'지역우선전형'"
               'StrSql = StrSql & vbCrLf & ",'학생부전형'"
               'StrSql = StrSql & vbCrLf & ")"
                'StrSql = StrSql & vbCrLf & "order by Subject, Division2, Division0, Division1"
				'StrSql = StrSql & vbCrLf & "order by Subject, Division2 asc, Division0, Division1"
                        ...
                        <div class="row-fluid">
                          ...
                          <div class="span12">
                            <table class="table table-striped table-hover table-bordered" style="atable-layout: fixed;">
                                <colgroup><col width="7%"></col><col width="5%"></col><col width="8%"></col><col width="8%"></col><col width="4%"></col><col width="4%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="6%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col></colgroup>
                              <thead>
                                <tr>
