...
function StudentUploadSave(){
    if(SavedFileName==""){
        alert("파일을 먼저 업로드 하세요.");
        return;
    }
    var url = "process/StudentUploadSave.asp"
                ...
                <div class="span12">
                    ...
                    <ul class="unstyled spaced">
                        <li>
                            ...
                            양식에 따라 엑셀 파일을 작성한 후 업로드 하시면 됩니다. (파일양식 : 지원자파일)
                        </li>
                        <li>
                            <i class="icon-ok green"></i>
                            엑셀 형태의 파일을 업로드하여 수험번호, 이름, 석차, 전화번호 등을 입력하는 기능입니다.
                        </li>
                    </ul>
                    ...
                    <div class="widget-box transparent" style="margin-top: 12px; padding-bottom: 0px; margin-bottom: 0px; ">
                        <div class="widget-header widget-header-small" style="padding-bottom: 0px; margin-bottom: 0px; ">
                            ...
                            <div class="widget-toolbar action-buttons" style="padding-bottom: 0px; margin-bottom: 0px;">
                                ...
                                &nbsp; &nbsp;
                                <a href="javascript: StudentUploadSave();" class="pink" title="저장">
...
<script>
    ...
    MyDhtmlxGrid.setHeader("모집코드,수험번호,이름,석차,점수,총계,전화번호1,전화번호2,전화번호3,전화번호4,전화번호5,주민번호앞,주민번호뒤,기타1,입력시각");
    MyDhtmlxGrid.setInitWidths("60,70,60,30,30,80,100,100,100,100,86,85,85,85,85")
    MyDhtmlxGrid.setColAlign("center,center,center,center,center,center,center,left,left,left,left,left,left,left,left")
    MyDhtmlxGrid.setColTypes("ed,ed,ed,ed,ed,ed,coro,ed,ed,ed,ed,ed,ed,ed,ro");
    ...
    MyDhtmlxGrid.setColSorting("str,str,str,int,str,str,str,str,str,str,str,str,str,str,date")
    ...
    function loadXML(SavedFileName){
        //window.open("process/StudentUploadGet.asp?SavedFileName="+SavedFileName);
        MyDhtmlxGrid.clearAndLoad("process/StudentUploadGet.asp?SavedFileName="+SavedFileName);
    }
</script>
</html>
