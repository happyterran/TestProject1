...
<head>
    ...
    <style>
		td{font-size:8pt; text-align:center; color:#333;}
    	h2{color:#444;}
        .fs15{font-size:15pt;}
        .b {text-align: center; padding-right: 0px;}
        .lb{text-align: center; padding-right: 0px; border-left-width:1px;}
        .rb{border-right-width:1px;}
        .bb{border-bottom-width:1px;}
        .tb{border-top-width:1px;}
        .lbb{border-left-width:1px; border-bottom-width:1px;}
        .rbb{border-right-width:1px; border-bottom-width:1px;}
        .rtb{border-right-width:1px; border-top-width:1px;}
        .ltb{border-left-width:1px; border-top-width:1px;}
...
Dim FilenameTime
FilenameTime = cstr(Year(Date())) & cstr(CipherEdit(Month(Date()),"0",2)) & cstr(CipherEdit(Day(Date()),"0",2)) & " " & cstr(CipherEdit(Hour(Time()),"0",2)) & cstr(CipherEdit(Minute(Time()),"0",2)) & cstr(CipherEdit(Second(Time()),"0",2))

Response.ContentType = "application/vnd.ms-excel"
Response.AddHeader "Content-type", "application/octet-stream"
Response.AddHeader "Content-Disposition","attachment; filename=" & getParameter(RS("MYear") & "학년 누적 등록인원 현황표 " & FilenameTime,"") &".xls"  
...
%>
	...
	<H3><center>2012학년 누적 등록인원 현황표</center></H3> --><BR>
	<script>StatsTitleForm.StatsTitle.value = "<%=Degree%>,<%=Flag%>";</script><%'선택한것 선택하기%>
	...
	<table border=1 cellspacing=0 cellpadding=0 bordercolor=black style="border-color:black; border-style:solid; border-collapse:collapse;" style="table-layout:fixed; border: 2px solid;" width="" align="center">
	<col width="95"></col><col width="34"></col>
	<col width="33"></col><col width="33"></col><col width="31"></col><col width="31"></col><col width="31"></col>
	<col width="33"></col><col width="33"></col><col width="31"></col><col width="31"></col><col width="31"></col>
	<col width="33"></col><col width="33"></col><col width="31"></col><col width="31"></col><col width="31"></col>
	<col width="33"></col><col width="33"></col><col width="31"></col><col width="31"></col><col width="31"></col>
	<col width="33"></col><col width="33"></col><col width="31"></col><col width="31"></col><col width="31"></col>
	...
	<tr bgcolor="ffffcc">
		...
		<td rowspan=2 class=lbb bgcolor="eaf1dd">합계</td>
		...
		<td rowspan=2 class=lbb bgcolor="eaf1dd">합계</td>
		<td rowspan=2 class=lbb bgcolor="eaf1dd">전체<%=vbCrLf%>합계</td>
	</tr>
	<tr bgcolor="ffffcc">
	<%Dim i, TempRemainCount, PrintRecord
	i=1
	Do Until i > ConstDegree%>
		<td class=lbb height="40">수시1<%=vbCrLf%>등록</td>
		<td class=bb>수시2<%=vbCrLf%>등록</td>
		<td class=bb>정시<%=vbCrLf%>등록</td>
		<td class=bb>등록<%=vbCrLf%>예정</td>
		<td class=bb>소계</td>
		<%i=i+1
	Loop%>
	</tr>
	...
	Dim CU11,  CU12,  CU20,  CU6,  CU6s	'기타외국인		10
	...
	Dim CU11Sum,  CU12Sum,  CU20Sum,  CU6Sum,  CU6sSum	'기타외국인		10
