    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span4">
          <!-- Logo. -->
          <div class="logo">
            <h1 style="margin-top: 10px;"><a href="/">Project<span class="bold">METIS 2.0</span></a></h1>
          ...
          <ul class="nav nav-pills" style="padding-bottom: 0px; margin-bottom: 0px;">
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="icon-comments"></i> 통화중 <span   class="badge badge-info">6</span> 
              </a>
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="icon-envelope-alt"></i> 등록예정 <span class="badge badge-important">6</span> 
              </a>
            ...
            <li class="dropdown dropdown-big">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                <i class="icon-user"></i> 잔여인원 <span   class="badge badge-success">6</span> 
              </a>
