                ...
                <div class="span12">
                    ...
                    <ul class="unstyled spaced">
                        <li>
                            ...
                            양식에 따라 텍스트 파일을 작성한 후 업로드 하시면 됩니다. (파일양식 : 명지전문대 결과_샘플)
                        </li>
                        <li>
                            <i class="icon-ok green"></i>
                            텍스트 형태의 파일을 업로드하여 수험번호, 결과, 차수를 입력하는 기능입니다.

                        </li>
                        <li>
                            <i class="icon-ok green"></i>
							입력 전 환경설정 > 차수설정을 꼭 확인해 주세요.
                        </li>

						<% If LCASE(Session("MemberID")) = LCASE("MetisSoft") Then %>
						<li>
                            <i class="icon-ok green"></i>
							MetisSoft Tip : 텍스트파일에 모집단위정보가 없어 환경설정 차수로 모집시기 별 차수 입력 못함.
							<br>
							<font color="#FFFFFF">MetisSoft Tip:::::::::::-</font>2017년 정시부터 텍스트 파일에 차수 포함 시킴 (예: G1220000097	등록완료	1)
                        </li>
						<% End If %>
                    ...
                    <div class="widget-box transparent" style="margin-top: 12px; padding-bottom: 0px; margin-bottom: 0px; ">
                        <div class="widget-header widget-header-small" style="padding-bottom: 0px; margin-bottom: 0px; ">
                            ...
                            <div class="widget-toolbar action-buttons" style="padding-bottom: 0px; margin-bottom: 0px;">
                                ...
                                &nbsp; &nbsp;
                                <a href="javascript: RegistUploadSave();" class="pink" title="저장">
...
<script>
    ...
    MyDhtmlxGrid.setHeader("모집코드,수험번호,결과,차수,입력시각");
