...
<!-- 
 ...
 -->
		...
		<%'##########  모집단위 선택  ########## 
            ...
            <button type="button" class="btn" onclick="javascript: document.location.reload();" style="margin-bottom: 10px;">
                  ...
                  <div class="widget" style="margin-top: 0; padding-top: 0;">
                    <div class="widget-head">
                      ...
                      <div class="widget-icons pull-right">
                        ...
                        <!--
                        <button type="button" class="btn" onclick='StatsView();'>
                            <i class="icon-bar-chart bigger-120"></i> 현황표 보기
                        </button>
                        -->
                        &nbsp; &nbsp; 
                        ...
                        <div class="row-fluid">
                          ...
                          <div class="span12">
                            <table class="table table-striped table-hover table-bordered" style="atable-layout: fixed;">
                                <colgroup><col width="6%"></col><col width="5%"></col><col width="11%"></col><col width="6%"></col><col width="4%"></col><!-- <col width="4%"></col> --><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col><col width="5%"></col></colgroup>
                              <thead>
                                <tr>
                                    ...
                                    <td colspan="1" style="padding: 7px 0px 6px 0px; text-align: center; border-right: #AAA 2px solid;">구분3</td> -->
                            ...
                            do Until Rs1.EOF
                                ...
                                <%If ShowSum Then%>
                                    <TR>
                                        <TD colspan="5" style="background-color: #e7e7e7; text-align: left; padding-left: 165px;">소계</TD>
                                        ...
                                        <TD colspan="1" style="background-color: #e7e7e7; text-align: right; padding-right: 10px; "><%=RemainCountSmallSum%></TD>
                                ...
                                <TR>
                                    ...
                                    <TD colspan="1" style="background-color: <%=BGColor%>; padding: 8px 0px 0px 1px; text-align: left;"><%=Left(SubjectCode,12)%></TD>
                                    ...
                                    <TD colspan="1" style="background-color: <%=BGColor%>; padding: 8px 0px 0px 1px; text-align: left;"><%=Division1%></TD>
                                    <TD colspan="1" style="background-color: <%=BGColor%>; padding: 8px 0px 0px 1px; text-align: left;" nowrap><%=Division2%></TD><!-- 
                                    <TD colspan="1" style="background-color: <%=BGColor%>; padding: 0px 0px 0px 1px; text-align: left; border-right: #AAA 2px solid;" nowrap><%=Division3%></TD> -->
                                    ...
                                    <TD colspan="1" style="background-color: <%=BGColor%>; padding: 8px 10px 5px 0px; text-align: right;" ><%=RemainCount%></TD>
                            ...
                            End If%>
                                ...
                                <TR>
                                    <TD colspan="5" style="background-color: #FFFFFF; text-align: left; padding-left: 165px;"><B>총합</B></TD>
                                    ...
                                    <TD colspan="1" style="font-weight:bold; background-color: #FFFFFF; text-align: right; padding-right: 10px;"><B><%=RemainCountSum%></B></TD>
                                    ...
                                    <TD colspan="1" style="font-weight:bold; background-color: #FFFFFF; text-align: right; padding-right: 10px; border-right: #AAA 2px solid;"><B><%=ResourceCountSum%></B></TD>
...
<!-- MessageForm -->
<FORM METHOD="POST" ACTION="<%=Request.ServerVariables("URL")%>" Name="MessageForm">
