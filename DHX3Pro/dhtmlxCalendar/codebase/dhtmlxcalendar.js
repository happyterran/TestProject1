function dhtmlXCalendarObject(inps, skin) {
	...
	this._drawMonth = function(d) {
		...
		this.contMonth.firstChild.firstChild.childNodes[2].innerHTML = d.getFullYear()+"년";
...
dhtmlXCalendarObject.prototype.langData["kr"] = {
	dateformat: '%Y-%m-%d',
	monthesFNames: "1월,2월,3월,4월,5월,6월,7월,8월,9월,10월,11월,12월".split(","),
	monthesSNames: "1월,2월,3월,4월,5월,6월,7월,8월,9월,10월,11월,12월".split(","),
	daysFNames: "일요일,월요일,화요일,수요일,목요일,금요일,토요일".split(","),
	daysSNames: "일,월,화,수,목,금,토".split(","),
	weekstart: 1
};
