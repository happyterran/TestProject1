...
If Request.Form("SelectCount") <> "" Then Session("SelectCount") = Request.Form("SelectCount")
...
<SELECT NAME="SelectCount" onchange="MenuForm.submit();" style="width: 150px;">
    <option value="50" <%If Session("SelectCount")="50" Then%>selected<%End If%>>50 개씩 보기</option>
    <option value="100"<%If Session("SelectCount")="100"Then%>selected<%End If%>>100 개씩 보기</option>
    <option value="200"<%If Session("SelectCount")="200"Then%>selected<%End If%>>200 개씩 보기</option>
    <option value="500"<%If Session("SelectCount")="500"Then%>selected<%End If%>>500 개씩 보기</option>
</SELECT>
