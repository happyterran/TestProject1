      ...
      <div class="page-head">
        <h2 class="pull-left" style="color: #666;">
            <%If Session("Grade")="관리자" Then%>
                <i class="icon-bar-chart"></i> 작업결과
            <%Else%>
                <a href="/Root.asp" style="color: #AAA;"><i class="icon-file-alt"></i> 충원작업</a> &nbsp; 
                <i class="icon-bar-chart"></i> <b>작업결과</b>
            <%End If%>
        </h2>
        <!-- Breadcrumb -->
        <div class="bread-crumb pull-right">
          ...
          <a href="/RootResult.asp" class="bread-current">작업결과</a>
        </div>
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            <div class="span12">
                ...
                <!-- #include virtual = "/ResultFrame.asp" -->
...
<script type="text/javascript">
    ...
    function RootResultUpdate(obj1,obj2,Status){
        var myform = obj1;
                ...
                if(myform.elements[i].checked){
                    if(confirm("전화 없이 선택한 지원자들의 결과를 입력합니다. 계속하시겠습니까?")==true){
                        ...
                        if (confirm(StatusStr+" 맞습니까?")==true){
                            ...
                            myform.action="RootResultInsertRegistRecord.asp";
                            myform.submit();
                        }
                        return;
                    }else{
        ...
        myModalRootClick("작업결과 일괄입력","일괄입력할 지원자를 먼저 선택하세요");
    }
</script>
